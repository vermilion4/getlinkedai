...
const MobileNav = ({ setShowMobileNav, isActive }) => {
  ...
  return (
    <nav className='bg-secondary w-screen sm:w-[348px] right-[10px] h-[492px] px-[49px] sm:right-[49px] pt-[120px] border-[0.5px] border-white border-opacity-[4%] rounded-lg backdrop-filter backdrop-blur-[30px] mt-[111px] lg:mt-[140px] fixed transition-all ease-in duration-300 z-[999]'>
